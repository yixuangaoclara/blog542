...
```
A well-trained model should achieve an accuracy score above 90% on this dataset.
...
disp.plot()
```
This will produce a matrix showing the counts of correct and incorrect predictions for each class.
